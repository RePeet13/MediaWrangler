import argparse, logging, os, socket
...
def crossHostLister(hostLists):
    # HostLists is a dict of lists with the keys being the hosts they come from.
    # This should generate:
    # - Master list of movies/media
    # - Master list of dupes and where they are
    # - Consolidation lists for each host, and where missing media is available
    pass
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dir-output', dest='output', help='Folder to dump the output of individual dupe checking into')
    parser.add_argument('-o', '--output', dest='output', help='File to dump the final output of dupe checking into')
    parser.add_argument('-i', '--input', dest='input', help='Files to load generated output and check dupes', nargs='*')
